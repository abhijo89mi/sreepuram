...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('blog_post', (
            ...
            ('publish_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2012, 3, 4, 23, 49, 47, 860817))),
        ...
        db.create_table('blog_comment', (
            ...
            ('submit_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2012, 3, 4, 23, 49, 47, 862306))),
        ))
    ...
    models = {
        ...
        'blog.comment': {
            ...
            'submit_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 3, 4, 23, 49, 47, 862306)'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '200'})
        },
        'blog.post': {
            ...
            'publish_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 3, 4, 23, 49, 47, 860817)'}),
            'slug': ('django.db.models.fields.SlugField', [], {'unique': 'True', 'max_length': '50', 'db_index': 'True'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '200'})
        },
